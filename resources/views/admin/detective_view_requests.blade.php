                                                                ...
                                                                <form  method="POST" action="{{ route('admin.create.statements') }}">
                                                                    ...
                                                                    <div class="form-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="text" hidden=""name="date"class="form-control" placeholder="Enter text">

                                                                      </div>
                                                                        <input hidden=""name="crime_id" value="">
                                                                        <input hidden=""name="user_id" value="">
                                                                ...
                                                                <form action="#">
                                                                    ...
                                                                    <div class="form-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <!-- <input name="crime_description"  type="text" required="required" class="form-control" placeholder="Enter Last Name" /> -->
                                                                            <textarea class="form-control" placeholder=""  name="crime_description" rows="5" required="required"></textarea>
                                                                        </div>
                                                                        <div class="form-actions">
<!--
