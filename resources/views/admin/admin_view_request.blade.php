                                                                ...
                                                                <form  method="POST" action="{{ route('admin.create.statements') }}">
                                                                    ...
                                                                    <div class="form-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="date" hidden="{{$request[0]->user->id}}"name="date"class="form-control" placeholder="Enter text">

                                                                      </div>
                                                                        <input hidden="{{$request[0]->id}}"name="crime_id" value="{{$request[0]->id}}">
                                                                ...
                                                                <form action="#">
                                                                    ...
                                                                    <div class="form-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" value="{{$request[0]->idNo}}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="control-label">phone</label>
                                                                            <input type="text" class="form-control" value="{{$request[0]->phonenumber}}">
                                                                        </div>
                                                                        <div class="form-group">
