					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<!--<img class="nav-user-photo" src="assets/images/avatars/avatar2.jpg" alt="Jason's Photo" />-->
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo $this->session->userdata('name');?></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name">Move From: </div>

													<div class="profile-info-value">
														<i class="fa fa-map-marker light-orange bigger-110"></i>
													
														<span class="editable" id="city"><?php for($i =0; $i < 1; ++$i)
														{
															echo $schedule_list[$i]->destination_to;
														}?></span>
													</div>
												</div>
												<div class="profile-info-row">
													<div class="profile-info-name">Move To: </div>
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="city"><?php for($i =0; $i < 1; ++$i)
														{
															echo $schedule_list[$i]->destination_from;
														}?></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> Date of move </div>

													<div class="profile-info-value">
														<span class="editable" id="age"><?php 
														
															echo $schedule_list[$i]->date_time_of_move;
														?></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name">wall unit</div>

													<div class="profile-info-value">
														<span class="editable" id="signup"><?php for($i =0; $i < 1; ++$i)
														{
															echo $item_list[$i]->wall_unit;
														}?></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> sofa </div>

													<div class="profile-info-value">
														<span class="editable" id="login"><?php for($i =0; $i < 1; ++$i)
														{
															echo $item_list[$i]->sofa;
														}?></span>
													</div>
												</div>
												
												<div class="profile-info-row">
													<div class="profile-info-name"> bed </div>

													<div class="profile-info-value">
														<span class="editable" id="login"><?php for($i =0; $i < 1; ++$i)
														{
															echo $item_list[$i]->bed;
														}?></span>
													</div>
												</div>
												
												<div class="profile-info-row">
													<div class="profile-info-name"> utensils </div>

													<div class="profile-info-value">
														<span class="editable" id="about"><?php for($i =0; $i < 1; ++$i)
														{
															echo $item_list[$i]->utensils;
														}?></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> electronics </div>

													<div class="profile-info-value">
														<span class="editable" id="about"><?php for($i =0; $i < 1; ++$i)
														{
															echo $item_list[$i]->electronics;
														}?></span>
													</div>
												</div>
												<div class="profile-info-row">
													<div class="profile-info-name"> Other items </div>
...
&nbsp;
											...
											<div class="center">
												<button type="button" class="btn btn-sm btn-primary btn-white btn-round">
													...
													<span class="bigger-110">Cornfirm</span>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Hama</span>
							App &copy; 2013-2014
						</span>
